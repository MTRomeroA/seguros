...
const insuranceOptions = [
    ...
    { id: 'economico', label: <p className="flex flex-col gap-0 text-slate-800/80"><span className="font-bold text-slate-700">Básico</span> Coberturas integrales y oncológicas sobre el 100% </p>, value: 'economico' },
    ...
    { id: 'completo', label: <p className="flex flex-col gap-0 text-slate-800/80"><span className="font-bold text-slate-700">Gama media-alta</span> Cobertura integral y oncológica al 100% en casi todos las clínicas a nivel nacional. </p>, value: 'completo' },
